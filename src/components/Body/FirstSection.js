...
<div className="mr-1 card">
    ...
    <button type="button" className="btn2 mine block focus:outline-none mx-auto px-10 rounded-full text-xl font-medium py-2 mt-4 bg-indigo-700 text-white ">report now</button> <p className="btn">Early Infection Sources</p>
